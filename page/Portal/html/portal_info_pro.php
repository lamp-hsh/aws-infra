                ...
                <div>
                    <input type="button" class="side_menubar2" value="교수전용"></input>
                        <div id="side_menu_scroll">
                            <input type="button" class="side_menubar3" value="학적정보"></input>
                                <input type="button" class="side_menubar4" value="·학사일정조회"></input>
                                <input type="button" onclick="location.href='#" class="side_menubar4" value="·신상정보관리"></input>
                                <input type="button" class="side_menubar4" value="·교수종합정보조회"></input>
                        <input type="button" class="side_menubar3" value="교육과정정보"></input>

                        <input type="button" class="side_menubar3" value="강의정보"></input>
                        <input type="button" class="side_menubar3" value="학생서"></input>
                        <input type="button" class="side_menubar3" value="학생성적정보"></input>
                            <input type="button" onclick="location.href='./portal_info_pro1.html'" class="side_menubar4" value="·1학년"></input>    
                            <input type="button" onclick="location.href='./portal_info_pro2.html'" class="side_menubar4" value="·2학년"></input>
                            <input type="button" onclick="location.href='./portal_info_pro3.html'" class="side_menubar4" value="·3학년"></input>
                            <input type="button" class="side_menubar4" value="·온라인강좌 강의평가 결과 조회"></input>
                        <input type="button" class="side_menubar3" value="교직정보"></input>
                        <input type="button" class="side_menubar3" value="취업정보"></input>
                        <input type="button" class="side_menubar3" value="설문"></input>
                    </div>
                </div>
                        ...
                        <div id="main1">
                            ...
                            <div class="main4">
                                ...
                                <div class="info">
                                    <div id="line1">
                                        <div class="std">
                                            <div class="std_id1"><p>&nbsp;&nbsp;&nbsp;&nbsp;소속학과</p></div>
                                            <div><input class="std_id1-1" type="text"></div>
                                        </div>
                                        <div class="std">
                                            <div class="std_id1"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;성명</p></div>
                                            <div><input class="std_id1-1" type="text"></div>
                                        </div>
                                        <div id="std_phone_number">
                                            <div class="std_id1"><p>&nbsp;&nbsp;&nbsp;&nbsp;전화번호</p></div>
                                            <div><input id="std_phone_number1" type="text"></div>
                                        </div>
                                        <div id="std_adress">
                                            <div class="std_id1"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;집주소</p></div>
                                            <div><input id="std_adress_info" type="text"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
