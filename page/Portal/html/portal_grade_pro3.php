                ...
                /* 데이터베이스 연결확인 */
                 ...
                 $students_grade = htmlentities($_POST['grade']);
                  ...
                  if(strlen($students_number) || strlen($students_name)) {
                   ...
                   Add3rd_grader($connection, $students_number, $students_name, $students_exam1, $students_exam2, $students_assignment, $students_percentile, $students_grade);
                 }

                 ?>

                <form action="./portal_grade_pro3.php" method="POST">
                  ...
                  <?php
                      ...
                      $database = mysqli_select_db($connection, DB_DATABASE_S);
                        ...
                        if(strlen($students_number_d) > 0) {
                          ...
                          $query_d = "UPDATE 3rd_grader SET name='$students_name_d', exam1=$students_exam1_d, exam2=$students_exam2_d, assignment=$students_assignment_d, percentile=$students_percentile_d, grade=$students_grade_d WHERE number=$students_number_d;";
                  ...
                  <form action="<?PHP echo $_SERVER['SCRIPT_NAME'] ?>" method="POST">
                    ...
                    <table class="grade_table2" border="1" cellpadding="2" cellspacing="2">
                      ...
                      $result = mysqli_query($connection, "SELECT * FROM 3rd_grader;");
...
function Add3rd_grader($connection, $students_number, $students_name, $students_exam1, $students_exam2, $students_assignment, $students_percentile, $students_grade) {
   ...
   $query = "INSERT INTO 3rd_grader(number, name, exam1, exam2, assignment, percentile, grade) VALUES('$num', '$n', '$e1', '$e2', '$a', '$p', '$g');";
